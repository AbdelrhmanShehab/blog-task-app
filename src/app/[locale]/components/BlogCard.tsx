...
export default function BlogCard({
  ...
  return (
    <article className="bg-white cursor-pointer  w-full dark:bg-[#131421] h-full rounded-2xl shadow-xl overflow-hidden  border-b-blue-950 p-4 transition hover:shadow-lg hover:scale-105">
